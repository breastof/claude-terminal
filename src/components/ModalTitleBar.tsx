  ...
  return (
    <div className="flex items-center h-11 px-3.5 border-b border-border select-none shrink-0 bg-surface-alt">
      <div className="flex items-center gap-2 mr-3">
        <button
          onClick={onClose}
          className="w-[13px] h-[13px] rounded-full bg-[var(--th-traffic-close)] hover:brightness-90 transition cursor-pointer group flex items-center justify-center"
          aria-label="Закрыть"
        >
          <svg
            className="w-[7px] h-[7px] text-[var(--th-traffic-close-icon)] opacity-0 group-hover:opacity-100 transition-opacity"
            viewBox="0 0 12 12"
            fill="none"
            stroke="currentColor"
            strokeWidth={2}
        ...
        <div className="w-[13px] h-[13px] rounded-full bg-[var(--th-traffic-minimize)]" />
        <div className="w-[13px] h-[13px] rounded-full bg-[var(--th-traffic-maximize)]" />
      </div>
  ...
  return (
    <div className="flex items-center justify-between h-10 pl-3.5 border-b border-border select-none shrink-0 bg-surface-alt">
      ...
      <div className="flex items-center h-full">
        ...
        <button
          onClick={onClose}
          className="w-[46px] h-full flex items-center justify-center text-muted-fg hover:bg-[var(--th-win-close-hover)] hover:text-white transition-colors cursor-pointer rounded-tr-[var(--th-radius)]"
          aria-label="Закрыть"
        >
          <svg
            width="10"
